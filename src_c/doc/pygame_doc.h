...
#define DOC_VERSION "Pygame module containing version information."
#define DOC_VERSION_VER "ver -> str\nVersion number as a string."
#define DOC_VERSION_VERNUM "vernum -> PygameVersion\nTupled integers of the version."
#define DOC_VERSION_REV "rev -> str\nRepository revision of the build."
#define DOC_VERSION_SDL "SDL -> SDLVersion\nTupled integers of the SDL library version."
