...
#define DOC_COLOR "Color(r, g, b, a=255) -> Color\nColor(rgbvalue) -> Color\nPygame object for color representations."
...
#define DOC_COLOR_NORMALIZED "normalized -> tuple[float, float, float, float]\nGets or sets the normalized representation of the Color."
...
#define DOC_COLOR_NORMALIZE "normalize() -> tuple[float, float, float, float]\nReturns the normalized RGBA values of the Color."
#define DOC_COLOR_CORRECTGAMMA "correct_gamma(gamma, /) -> Color\nApplies a certain gamma value to the Color."
#define DOC_COLOR_SETLENGTH "set_length(length, /) -> None\nSet the number of elements in the Color to 1,2,3, or 4."
