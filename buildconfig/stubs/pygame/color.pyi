...
class Color(Collection[int]):
    ...
    def grayscale(self) -> Color:
        ...
        Returns a new Color object which represents the grayscaled version of self,
        using the luminosity formula, which weights red, green, and blue according
        to their relative contribution to perceived brightness.
    ...
    def update(self, rgbvalue: ColorLike, /) -> None:
        ...
        See parameters for :meth:`pygame.Color` for the parameters of this function.
